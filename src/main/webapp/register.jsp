...
<body>
<br><br><br><br><br>
<form class="register-RegisterForm" enctype="application/x-www-form-urlencoded" method="POST">
    <label>
        Username:
    ...
    <label>
        Confirm pass:
        <input type="password" minlength="1" required name="cpassword" />
    </label><br>
...
<br><br>
<a href="${pageContext.request.contextPath}/login">Already have an account?</a><br>
